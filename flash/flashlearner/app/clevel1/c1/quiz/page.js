...
const sampleQuestions = [
  ...
  {
    "text": "What is the correct way to print 'Hello, World!' in C++?",
    "options": [
      "print('Hello, World!');",
      "cout << 'Hello, World!';",
      "printf('Hello, World!');",
  ...
  {
    "text": "Which data type is used to store decimal numbers in C++?",
    "options": ["int", "float", "char", "bool"],
    "correct": 1
  },
  {
    "text": "Which statement is used for decision-making in C++?",
    "options": ["if", "switch", "both if and switch", "while"],
    "correct": 2
  },
  {
    "text": "What will be the output of: if(5 > 3) cout << 'Yes'; else cout << 'No';?",
    "options": ["Yes", "No", "Error", "None of the above"],
    "correct": 0
  },
  {
    "text": "Which loop executes at least once regardless of the condition?",
    "options": ["for", "while", "do-while", "none of the above"],
    "correct": 2
  },
  {
    "text": "Which of the following correctly initializes a for loop?",
    "options": [
      "for(int i = 0; i < 5; i++)",
      "for(int i = 0; i < 5)",
      "for i in range(5)",
  ...
  {
    "text": "Which loop is best suited when the number of iterations is known beforehand?",
